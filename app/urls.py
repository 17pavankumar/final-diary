...
urlpatterns = [
    ...
    path('logout/', auth_view.LogoutView.as_view(next_page='login'), name='logout_page'),
...
admin.site.site_header = 'Pavan Diary'
admin.site.site_title = 'Pavan Diary'
admin.site.site_index_title = 'Welcome to Pavan Diary shop'